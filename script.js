...
async function handleContactSubmit(e) {
  ...
  try {
    await addDoc(collection(db, FIREBASE_COLLECTIONS.leads), {
    ...
    console.error('Unable to submit lead to Firestore.', error);
    showToast('We could not send your inquiry right now. Please try again.');
  } finally {
    btn.textContent = 'Send Inquiry';
    btn.disabled = false;
  }
